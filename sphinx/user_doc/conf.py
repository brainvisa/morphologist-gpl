...
# of the sidebar.
html_logo = 'images/brainvisa.png'
...
latex_documents = [
    ('index', 'morphologist.tex', u'Morphologist User Documentation',
     u'someone', 'manual'),
]
...
morphoui_version = '1.1'
try:
    from morphologist import info as moui
    morphoui_version = '%d.%d' % (moui.version_major, moui.version_minor)
except ImportError:
    pass
...
extlinks = {
    ...
    'morphoproc': ('../../axon-' + axon_version + '/en/processes/%s',
                    'morphologist '),
    'morpho_api': ('../dev_doc/%s', 'morpho-api '),
    'morphouiusr': ('../../morphologist-ui-' + morphoui_version + '/%s',
                    'morphoui '),
    'morphodeep_dev': ('../../morpho-deepsulci-' + version + '/dev_doc/%s', 'morphodeep '),
...
intersphinx_mapping = {
    ...
    'morphouiusr': ('doc/morphologist-ui/%s', 'morphoui '),
}
