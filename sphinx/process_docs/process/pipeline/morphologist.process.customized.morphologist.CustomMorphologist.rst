...
.. _morphologist.process.customized.morphologist.CustomMorphologist:

CustomMorphologist
------------------

.. currentmodule:: morphologist.process.customized.morphologist
...
.. note::
    ...
    * Type 'CustomMorphologist.help()' for a full description of this process parameters.
    * Type '<CustomMorphologist>.get_input_spec()' for a full description of this process input trait types.
    * Type '<CustomMorphologist>.get_output_spec()' for a full description of this process output trait types.
...
| |     No description.                                                                                   |
+---------------------------------------------------------------------------------------------------------+
| | **normalization_transformation**: any value                                                           |
| |     No description.                                                                                   |
+---------------------------------------------------------------------------------------------------------+
