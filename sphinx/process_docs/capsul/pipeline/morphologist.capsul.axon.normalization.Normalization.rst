...
morphologist.capsul.axon.normalization.Normalization
====================================================


.. _morphologist.capsul.axon.normalization.Normalization:

Normalization
-------------

.. currentmodule:: morphologist.capsul.axon.normalization
...
.. note::
    ...
    * Type 'Normalization.help()' for a full description of this process parameters.
    * Type '<Normalization>.get_input_spec()' for a full description of this process input trait types.
    * Type '<Normalization>.get_output_spec()' for a full description of this process output trait types.
...
.. image:: ../schema/morphologist.capsul.axon.normalization.Normalization.png
    :height: 400px
    :align: center
