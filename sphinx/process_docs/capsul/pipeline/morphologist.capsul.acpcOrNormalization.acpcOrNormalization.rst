...
morphologist.capsul.acpcOrNormalization.acpcOrNormalization
===========================================================


.. _morphologist.capsul.acpcOrNormalization.acpcOrNormalization:

acpcOrNormalization
-------------------

.. currentmodule:: morphologist.capsul.acpcOrNormalization
...
.. note::
    ...
    * Type 'acpcOrNormalization.help()' for a full description of this process parameters.
    * Type '<acpcOrNormalization>.get_input_spec()' for a full description of this process input trait types.
    * Type '<acpcOrNormalization>.get_output_spec()' for a full description of this process output trait types.
