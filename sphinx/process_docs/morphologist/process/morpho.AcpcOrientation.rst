...
morphologist.capsul.axon.acpcorientation.AcpcOrientation
========================================================


.. _morphologist.capsul.axon.acpcorientation.AcpcOrientation:

AcpcOrientation
---------------

.. currentmodule:: morphologist.capsul.axon.acpcorientation
...
.. note::
    ...
    * Type 'AcpcOrientation.help()' for a full description of this process parameters.
    * Type '<AcpcOrientation>.get_input_spec()' for a full description of this process input trait types.
    * Type '<AcpcOrientation>.get_output_spec()' for a full description of this process output trait types.
