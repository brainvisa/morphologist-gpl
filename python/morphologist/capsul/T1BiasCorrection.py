...
class T1BiasCorrection(Process):
    def __init__(self, **kwargs):
        ...
        self.add_trait('t1mri_nobias', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        ...
        self.add_trait('field', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        self.add_trait('write_hfiltered', Enum('yes', 'no'))
        self.add_trait('hfiltered', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        self.add_trait('write_wridges', Enum('yes', 'no', 'read'))
        self.add_trait('white_ridges', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        self.add_trait('variance_fraction', Int())
        self.add_trait('write_variance', Enum('yes', 'no'))
        self.add_trait('variance', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        self.add_trait('edge_mask', Enum('yes', 'no'))
        self.add_trait('write_edges', Enum('yes', 'no'))
        self.add_trait('edges', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
        self.add_trait('write_meancurvature', Enum('yes', 'no'))
        self.add_trait('meancurvature', File(allowed_extensions=['.nii.gz', '.v', '.i', '.mnc', '.mnc.gz', '.nii', '.jpg', '.gif', '.png', '.mng', '.bmp', '.pbm', '.pgm', '.ppm', '.xbm', '.xpm', '.tiff', '.img', '.hdr', '.ima', '.dim', '.vimg', '.vinfo', '.vhdr', ''], output=True))
