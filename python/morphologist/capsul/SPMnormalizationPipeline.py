...
class SPMnormalizationPipeline(Pipeline):
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process('NormalizeSPM', 'morphologist.capsul.Normalization_SPM_reinit.Normalization_SPM_reinit')
        self.add_process('ConvertSPMnormalizationToAIMS', 'morphologist.capsul.SPMsn3dToAims.SPMsn3dToAims')
        ...
        # export output parameter
        self.export_parameter('NormalizeSPM', 'normalized_anatomy_data', 'normalized_t1mri')
        # export input parameter
        self.export_parameter('NormalizeSPM', 'anatomical_template', 'template')
        # export input parameter
