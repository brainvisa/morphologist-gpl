...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process('SkullStripping', 'morphologist.capsul.skullstripping.skullstripping')
