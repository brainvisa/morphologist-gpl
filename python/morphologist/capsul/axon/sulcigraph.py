...
class SulciGraph(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field('roots', File, read=True, extensions=['.nii.gz', '.svs', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.bif', '.czi', '.mnc.gz'])
        ...
        self.add_field('split_brain', File, read=True, extensions=['.nii.gz', '.svs', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.bif', '.czi', '.mnc.gz'], optional=True)
        self.add_field('white_mesh', File, read=True, extensions=['.gii', '.mesh', '.obj', '.ply', '.tri'])
        self.add_field('pial_mesh', File, read=True, extensions=['.gii', '.mesh', '.obj', '.ply', '.tri'])
        ...
        self.add_field('cortex_mid_interface', File, write=True, extensions=['.nii.gz', '.dcm', '', '.i', '.v', '.fdf', '.ima', '.dim', '.jpg', '.mnc', '.nii', '.img', '.hdr', '.tiff', '.tif', '.mnc.gz'], optional=True)
