...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        ...
        self.add_process('GreyWhiteClassification_1', 'morphologist.capsul.axon.greywhiteclassificationhemi.GreyWhiteClassificationHemi')
        ...
        self.add_link('Renorm.talairach_transformation->Report.talairach_transform')
        ...
        self.add_link('GreyWhiteClassification.grey_white->SulciRecognition.CNN_recognition19_grey_white')
        ...
        self.add_link('GreyWhiteClassification_1.grey_white->SulciRecognition_1.CNN_recognition19_grey_white')
