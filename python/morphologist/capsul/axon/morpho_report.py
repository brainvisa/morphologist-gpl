...
class morpho_report(Process):
    def __init__(self, **kwargs):
        ...
        self.add_field('left_grey_white', File, read=True, extensions=['.nii.gz', '.svs', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.bif', '.czi', '.mnc.gz'], optional=True)
        self.add_field('right_grey_white', File, read=True, extensions=['.nii.gz', '.svs', '.dcm', '', '.i', '.v', '.fdf', '.mgh', '.mgz', '.ima', '.dim', '.ndpi', '.vms', '.vmu', '.jpg', '.scn', '.mnc', '.nii', '.img', '.hdr', '.svslide', '.tiff', '.tif', '.bif', '.czi', '.mnc.gz'], optional=True)
        ...
        self.add_field('talairach_transform', File, read=True, extensions=['.trm'], optional=True)
        self.add_field('brain_volumes_file', File, read=True, extensions=['.csv'], optional=True)
        self.add_field('normative_brain_stats', File, read=True, extensions=['.json'], optional=True, dataset=None)
        self.add_field('report', File, write=True, extensions=['.pdf'])
        self.add_field('report_json', File, write=True, extensions=['.json'], optional=True)
