...
class SulciLabellingANN(Process):
    def __init__(self, **kwargs):
        ...
        self.model = '/volatile/home/dr144257/brainvisa-sf-master/build/share/brainvisa-share-5.2/models/models_2008/discriminative_models/3.0/Rfolds_noroots/Rfolds_noroots.arg'
        self.model_hint = 0
        self.rate = 0.98
        self.stopRate = 0.05
