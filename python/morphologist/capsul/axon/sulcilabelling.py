...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        ...
        # switches section
        self.add_switch('select_Sulci_Recognition', ['recognition2000', 'SPAM_recognition09', 'CNN_recognition19'], ['output_graph'], output_types=[field(type_=File, write=True, allowed_extensions=['.arg', '.data'])], opt_nodes=True)
