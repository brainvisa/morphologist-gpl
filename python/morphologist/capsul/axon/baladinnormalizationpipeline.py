...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process('NormalizeBaladin', 'morphologist.capsul.axon.normalization_baladin.Normalization_Baladin')
        self.add_process('ConvertBaladinNormalizationToAIMS', 'morphologist.capsul.axon.baladinnormalizationtoaims.BaladinNormalizationToAims')
