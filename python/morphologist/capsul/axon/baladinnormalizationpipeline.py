...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process(
            'NormalizeBaladin', 'morphologist.capsul.axon.normalization_baladin.Normalization_Baladin')
        self.add_process('ConvertBaladinNormalizationToAIMS',
                         'morphologist.capsul.axon.baladinnormalizationtoaims.BaladinNormalizationToAims')
        self.add_process(
        ...
        # export input parameter
        self.export_parameter('NormalizeBaladin',
                              'anatomical_template', 'template')
        # export input parameter
        self.export_parameter('ConvertBaladinNormalizationToAIMS',
        ...
        self.add_link(
            'template->ConvertBaladinNormalizationToAIMS.registered_volume')
        self.add_link(
