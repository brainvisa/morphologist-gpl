...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        ...
        self.add_process('normalization_t1_spm12_reinit',
                         'morphologist.capsul.axon.normalization_t1_spm12_reinit.normalization_t1_spm12_reinit')
        ...
        self.export_parameter(
            'normalization_t1_spm12_reinit', 'anatomy_data', 't1mri')
        # export output parameter
        self.export_parameter(
            'ReorientAnatomy', 'output_transformation', 'transformation')
        # export output parameter
        self.export_parameter(
            'NormalizeSPM', 'spm_transformation', 'spm_transformation')
        # export output parameter
        self.export_parameter(
            'NormalizeSPM', 'normalized_t1mri', 'normalized_t1mri')
        # export input parameter
        self.export_parameter('normalization_t1_spm12_reinit',
        ...
        # export input parameter
        self.export_parameter('normalization_t1_spm12_reinit',
                              'allow_retry_initialization', 'allow_retry_initialization')
        # export output parameter
        self.export_parameter(
            'ReorientAnatomy', 'output_t1mri', 'reoriented_t1mri')
        # export input parameter
        self.export_parameter('normalization_t1_spm12_reinit',
                              'init_translation_origin', 'init_translation_origin')
        # export input parameter
        self.export_parameter(
            'normalization_t1_spm12_reinit', 'voxel_size', 'voxel_size')
        # export input parameter
        self.export_parameter('normalization_t1_spm12_reinit',
