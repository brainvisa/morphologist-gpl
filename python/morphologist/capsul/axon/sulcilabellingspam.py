...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        ...
        # switches section
        self.add_switch('local_or_markovian', ['local_recognition', 'markovian_recognition'], ['output_graph'], output_types=[field(type_=File, write=True, allowed_extensions=['.arg', '.data'])])
