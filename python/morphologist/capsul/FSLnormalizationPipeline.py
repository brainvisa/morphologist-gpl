...
class FSLnormalizationPipeline(Pipeline):
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process('NormalizeFSL', 'morphologist.capsul.Normalization_FSL_reinit.Normalization_FSL_reinit')
        self.add_process('ConvertFSLnormalizationToAIMS', 'morphologist.capsul.FSLnormalizationToAims.FSLnormalizationToAims')
