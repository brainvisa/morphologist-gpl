...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        # nodes section
        self.add_process('global_recognition', 'morphologist.capsul.spam_recognitionglobal.spam_recognitionglobal')
        self.add_switch('local_or_markovian', ['local_recognition', 'markovian_recognition'], ['output_graph'])
        self.add_process('local_recognition', 'morphologist.capsul.spam_recognitionlocal.spam_recognitionlocal')
        self.nodes['local_recognition']._weak_outputs = True
        self.add_process('markovian_recognition', 'morphologist.capsul.spam_recognitionmarkov.spam_recognitionmarkov')
