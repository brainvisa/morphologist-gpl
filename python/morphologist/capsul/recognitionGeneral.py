...
#            self.autoexport_nodes_parameters()
    ...
    def pipeline_definition(self):
        ...
        self.add_process('recognition2000', 'morphologist.capsul.recognition.recognition')
        self.nodes['recognition2000']._weak_outputs = True
        self.add_process('SPAM_recognition09', 'morphologist.capsul.spam_recognition.spam_recognition')
